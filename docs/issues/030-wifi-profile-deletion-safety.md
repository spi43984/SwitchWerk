...
Dadurch ist für den Benutzer nicht nachvollziehbar:

- welche Geräte betroffen sind
- warum die Zuordnung verschwunden ist
- welche Konfiguration repariert werden muss
...
WLAN-Profil „Shelly Garage“ wird von 3 Geräten verwendet.

Dialog:

Dieses WLAN wird noch von folgenden Geräten verwendet:

- Garagentor
- Seitentor
- Werkstattlicht

Die WLAN-Zuordnung dieser Geräte wird entfernt.
