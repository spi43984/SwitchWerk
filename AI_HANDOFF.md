...
Dieser Branch aktualisiert ausschließlich Markdown-Dokumentation im Repository-Root.

Branch:

```text
docs-codex-workflow-root-md
```

Ziel:

- alle zentralen Markdown-Dateien im Repository-Root belassen
- Verweise auf Root-Dateien konsistent halten
- Codex-Kontextverbrauch reduzieren
- Rollen von ChatGPT Browser, Codex CLI im Docker-Container, GitHub und Ubuntu-Host klarer trennen
...
Das nächste offene fachliche App-Issue bleibt:
